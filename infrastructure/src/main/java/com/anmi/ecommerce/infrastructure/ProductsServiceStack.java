...
import static software.amazon.awscdk.services.elasticloadbalancingv2.Protocol.TCP;
    ...
    public ProductsServiceStack(final Construct scope, final String id,
        ...
        fargateTaskDefinition.addContainer("ProductsServiceContainer",
                ContainerDefinitionOptions.builder()
                        .image(ContainerImage.fromEcrRepository(productsServiceProps.repository(), "latest"))
